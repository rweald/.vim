" Vim color file
" Converted from Textmate theme Black Pearl II using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
hi Visual  guifg=NONE guibg=#b34c76 gui=NONE
hi CursorLine  guifg=NONE guibg=#0d2437 gui=NONE
hi CursorColumn  guifg=NONE guibg=#0d2437 gui=NONE
hi LineNr  guifg=#808c96 guibg=#00182c gui=NONE
hi VertSplit  guifg=#304454 guibg=#304454 gui=NONE
hi MatchParen  guifg=#f8bb00 guibg=NONE gui=bold
hi StatusLine  guifg=#ffffff guibg=#304454 gui=bold
hi StatusLineNC  guifg=#ffffff guibg=#304454 gui=NONE
hi Pmenu  guifg=NONE guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#b34c76 gui=NONE
hi IncSearch  guifg=NONE guibg=#524e1d gui=NONE
hi Search  guifg=NONE guibg=#524e1d gui=NONE
hi Directory  guifg=#66ccff guibg=NONE gui=NONE
hi Folded  guifg=#428bdd guibg=#00182c gui=NONE

hi Normal  guifg=#ffffff guibg=#00182c gui=NONE
...
hi NonText  guifg=#404040 guibg=#0d2437 gui=NONE
...
hi SpecialKey  guifg=#404040 guibg=#0d2437 gui=NONE
...
hi cssPseudoClassId  guifg=#b5b02e guibg=NONE gui=bold
hi cssClassName  guifg=#b5b02e guibg=NONE gui=bold
